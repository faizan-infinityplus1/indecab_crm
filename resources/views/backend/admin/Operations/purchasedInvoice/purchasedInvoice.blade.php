    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            ...
            <div class="text-end d-flex justify-content-end align-items-center gap-2">
                <div class="btn-group" role="group"><a href="/booking/create" class="btn btn-primary">Add Purchase Invoice</a>
                </div>
                <div class="dropdown">
        ...
        <ul class="nav nav-tabs border-0 d-flex flex-wrap mt-3">
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Purchase Invoices</a>
            </li>
            <li class="nav-item position-relative">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <p class="text-end" style="color: blue">
                    <a href="#">
                    View Totals (with TDS)
                    </a>|
                    <a href="#">View Totals (without TDS)</a>
                </p>
            </div>
        </div>

        <div class="well mb-3">
            <p class="text-center">No purchase invoices found.</p>
        </div>
    </div>
@endsection
