...
@section('content')
    <div class="card rounded-0 border-0 p-5">
        ...
        <div class="well text-center mb-3">
            <p class="text-center" style="font-size: 13px">Before you can start creating invoices, you need to set an
                'Code'. This would be the
                initial two letters of your invoice number. For example, if IC1718000001 is your invoice number you need to
                set the two initial letters 'IC'..</p>
            <div class="btn-group" role="group"><a href="/booking/create" class="btn btn-primary">Edit Company Profile</a>
            </div>
        </div>
    </div>
@endsection
