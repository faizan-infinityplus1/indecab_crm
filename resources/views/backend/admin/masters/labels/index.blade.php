...
@section('content')
    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            <h4>Labels</h4>
            <div class="btn-group" role="group"><a href="{{ route('labels.manage') }}" class="btn btn-primary">Add Label</a>
            </div>
        </div>
        <div class="card-body px-0">
            ...
            <div class="bg-light mb-3 p-3 text-center">
                Get started by adding <a href="{{ route('labels.manage') }}" class="text-decoration-none">labels</a> for
                your business.
            </div>
