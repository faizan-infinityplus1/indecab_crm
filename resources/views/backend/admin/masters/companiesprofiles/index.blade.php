    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            ...
            <div class="text-end d-flex justify-content-end align-items-center gap-2">
                <div class="btn-group" role="group"><a href="{{ route('companiesprofiles.manage') }}"
                        class="btn btn-primary">Add Company Profile</a></div>
            </div>
        </div>
                ...
                <table class="table table-striped table-hover datatable" style="width:100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Sister company: Uqaab Graphics | Sister company: Uqaab Holidays | Primary company: Mumbai
                                Cab Service</td>
                            <td>
                                <div class="dropdown">
