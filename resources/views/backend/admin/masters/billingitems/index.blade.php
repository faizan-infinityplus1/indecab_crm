    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            ...
            <div class="text-end d-flex justify-content-end align-items-center gap-2">
                <div class="btn-group" role="group"><a href="{{ route('billingitems.manage') }}" class="btn btn-primary">Add
                        Billing Item</a></div>
            </div>
        </div>
        <div class="card-body px-0">
            ...
            <div class="bg-light mb-3 p-3 text-center">
                Get started by adding <a href="{{ route('billingitems.manage') }}" class="text-decoration-none">billing
                    items</a> for your business.
            </div>
                    ...
                    <tbody>
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td>{!! $data->allow_driver_to_add
                                    ? '<span class="text-success">Yes</span>'
                                    : '<span class="text-secondary">No</span>' !!}</td>
                                <td>{!! $data->n_charged_on_customer_invoice
                                    ? '<span class="text-success">Yes</span>'
                                    : '<span class="text-secondary">No</span>' !!}</td>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('billingitems.manage', $data->id) }}">Edit</a>
                                            </li>
