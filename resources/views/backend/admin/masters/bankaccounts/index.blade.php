    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            ...
            <div class="text-end d-flex justify-content-end align-items-center gap-2">
                <div class="btn-group" role="group"><a href="{{ route('bankaccounts.manage') }}" class="btn btn-primary">Add
                        Bank Account</a></div>
            </div>
        </div>
        <div class="card-body px-0">
            ...
            <div class="bg-light mb-3 p-3 text-center">
                Get started by adding <a href="{{ route('bankaccounts.manage') }}" class="text-decoration-none">bank
                    accounts</a> for your business.
            </div>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('bankaccounts.manage', $data->id) }}">Edit</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
