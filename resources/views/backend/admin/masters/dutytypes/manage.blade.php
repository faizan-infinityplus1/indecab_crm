                ...
                <form action="{{ $data ? route('dutytype.update', $data->id) : route('dutytype.store') }}" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select border-bottom" name="duty_type" id="selectedType"
                            ...
                            <option value="hrKmLocal"
                                {{ old('selectedType', $data->duty_type ?? '') == 'hrKmLocal' ? 'selected' : '' }}>
                                HR-KM
                                (Local)
                            </option>
                            ...
                            <option value="flatRate"
                                {{ old('selectedType', $data->duty_type ?? '') == 'flatRate' ? 'selected' : '' }}>
                                Flat Rate</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="city_limit" class="js-states form-control" name="city_limit[]" multiple>
                            ...
                            ?>
                            <option value="Agra"
                                {{ in_array('Agra', old('city_limit', $selectedCities ?? [])) ? 'selected' : '' }}>
                                Agra
                            </option>
                            <option value="Delhi"
                                {{ in_array('Delhi', old('city_limit', $selectedCities ?? [])) ? 'selected' : '' }}>
                                Delhi
                            </option>
                            <option value="Mumbai"
                                {{ in_array('Mumbai', old('city_limit', $selectedCities ?? [])) ? 'selected' : '' }}>
                                Mumbai
                            </option>
                            <option value="Pune"
                                {{ in_array('Pune', old('city_limit', $selectedCities ?? [])) ? 'selected' : '' }}>
                                Pune
                            </option>
                        </select>
                        <span class="warning-msg-block"></span>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select border-bottom" name="sub_type" id="sub_type">
                                <option value="select_one"
                                    {{ old('sub_type', $data->sub_type ?? '') == 'select_one' ? 'selected' : '' }}>
                                    (Select One)</option>
                                <option value="airport"
                                    {{ old('sub_type', $data->sub_type ?? '') == 'airport' ? 'selected' : '' }}>
                                    Airport</option>
                                <option value="local"
                                    {{ old('sub_type', $data->sub_type ?? '') == 'local' ? 'selected' : '' }}>Local
                                </option>
                            </select>
                            <span class="warning-msg-block"></span>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#formDutyType").validate({
                ...
                messages: {
                    duty_type: {
                        required: "Please Select Duty Type"
                    },
                    duty_name: {
                        required: function() {
