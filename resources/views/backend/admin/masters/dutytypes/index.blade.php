...
@section('content')
    ...
    <div class="card rounded-0 border-0 p-5">
        <div class="card-header d-flex justify-content-between py-2 px-0 bg-transparent page-heading-container flex-wrap">
            <h4>Duty Types</h4>
            <div class="btn-group" role="group"><a href="{{ route('dutytype.manage') }}" class="btn btn-primary">Add Duty
                    Type</a></div>
        </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item view-activity-logs" href="#"
                                                    data-bs-toggle="modal" data-bs-target="#activity-log"
                                                    data-id="{{ $data->id }}" data-name="{{ $data->duty_name }}"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('dutytype.manage', $data->id) }}">Edit</a>
                                            </li>
                                            <li>
                                                {{-- <a class="dropdown-item text-danger" href="{{ route('dutytype.delete', $data->id) }}">Delete</a> --}}
                                                <a class="dropdown-item text-danger" href="#"
                                                    onclick="confirmDelete('{{ route('dutytype.delete', $data->id) }}')">Delete</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
