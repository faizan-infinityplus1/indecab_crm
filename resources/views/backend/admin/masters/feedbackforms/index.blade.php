...
<div class="card rounded-0 border-0 p-3">
    <div class="card-header d-flex justify-content-between py-2 bg-transparent page-heading-container flex-wrap">
        ...
        <div class="btn-group" role="group"><a href="{{route('feedbackforms.manage')}}" class="btn btn-primary">Add Feedback Form</a></div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <div class="bg-light mb-3 p-3 text-center">
            Get started by adding <a href="{{route('feedbackforms.manage')}}" class="text-decoration-none">feedback forms</a> for your business.
        </div>
