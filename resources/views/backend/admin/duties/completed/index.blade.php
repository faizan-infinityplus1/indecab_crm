...
<div class="card rounded-0 border-0 p-5">
    ...
    <div class="duties-nav-container">
        <ul class="nav nav-tabs border-0">
            <li class=""><a href="{{ route('duties.upcoming') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Upcoming</a>
            </li>
            <li class=""><a href="{{ route('duties.booked') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Booked</a>
            </li>
            <li class=""><a href="{{ route('duties.allotted') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Allotted</a>
            </li>
            <li class=""><a href="{{ route('duties.dispatched') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Dispatched</a>
            </li>
            <li class="active"><a href="{{ route('duties.completed') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Completed</a>
            </li>
            <li class=""><a href="{{ route('duties.billed') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Billed</a>
            </li>
            <li class=""><a href="{{ route('duties.cancelled') }}" class="p-3 d-inline-block text-decoration-none duties-nav-tabs">Cancelled</a>
            </li>
        ...
        <div class="row my-3">
            <div class="col-md-7 mb-3">
                <div class="position-relative">
                    <label for="" class="form-label position-absolute mb-1 bottom-0"><i class="fa-solid fa-magnifying-glass"></i></label>
                    <input type="text" name="" value="" class="form-control  border-bottom ps-4" id="" placeholder="Type here to filter by name, number, city, duty type, company name or booking ID">
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-danger">
                            Completed <i class="fa fa-check text-secondary" aria-hidden="true"></i>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="#" class="dropdown-item open-detail-modal" data-bs-toggle="modal" data-bs-target="#details" data-id="{{ $data->id }}">Details</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" id="get_duty_supplier" data-bs-target="#allot-duty-to-supplier" data-id="{{ $data->id }}">View Duty Slip</a>
                                    </li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#add-remove-lable" id="manageLabels" data-id="{{ $data->id }}">Add/Remove labels</a></li>
                                    <li><a href="#" class="dropdown-item edit-detail-modal" data-bs-toggle="modal" data-bs-target="#edit-duty" data-id="{{ $data->id }}">Edit duty</a></li>
                                    <li>
                                        <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#allot-supporters" id="allot_supporters" data-id="{{ $data->id }}">Allot
                                            supporters</a>
                                    </li>
                                    <li><a href="#" class="dropdown-item open-allot-vehicle-driver-modal" data-bs-toggle="modal" data-bs-target="#allot-vehicle-driver" data-id="{{ $data->id }}">Re-allot</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#allot-send-to-associate">Send to Associate</a>
                                    </li>
                                    <li><a href="#" class="dropdown-item" onclick="clearAllotment()">Clear
                                            Allotment</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" id="send-info" data-bs-target="#send-info" data-id="{{ $data->id }}">Send info</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Send driver/supplier location</a></li>

                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Mark as driver/supplier arrived</a></li>

                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#send-details-to-supplier">Send details to
                                            supplier</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#print-duty-slip">Print duty slip</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#create-placard">Create placard</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Mark as dispatched</a></li>

                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#close-duty">Close Duty</a></li>
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#advance-purchase-payment">Add Advance Purchase
                                            Payment</a></li>
                                    {{-- <li><a href="{{ route('bookings.specific-bookings') }}" class="dropdown-item">View Booking</a></li> --}}

                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#cancel-duty">Cancel Duty</a></li>
                                </ul>
                                {{-- @endif --}}
                                {{-- completed --}}
                            </div>
            ...
            <div class="modal-body px-5 bg-white">
                <ul class="nav nav-tabs border-0 w-100" id="tabs-nav">
                    ...
                    <li class="nav-item w-50 mb-3 active" id="details-tab">
                        <a href="#duty-detail-detail" class="p-3 d-block text-center text-decoration-none duties-nav-tabs active" data-bs-toggle="tab">Details</a>
                    </li>
                    <!-- Activity Tab Link -->
                    <li class="nav-item w-50 mb-3" id="activity-tab">
                        <a href="#duty-detail-activity" class="p-3 d-block text-center text-decoration-none duties-nav-tabs" data-bs-toggle="tab">Activity</a>
                    </li>
                </ul>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">Vijay Vaidyanathan ( <i class="fa-solid fa-phone text-success"></i>
                                        <a href="tel:+9840872950" class="text-decoration-none ">
                                            98408 72950 </a>)
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <ol class="ps-3" style="list-style-type: decimal;">
                                            <li>Vijay Vaidyanathan - <i class="fa-solid fa-phone text-success"></i> <a href="tel:+9840872950" class="text-decoration-none ">
                                                    98408 72950 </a></li>
                                        </ol>
                                    </td>
                                </tr>
...
<div class="modal fade" id="view-duty-slip" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog float-end activity-logs-modal my-0 h-100 bg-white">
        <div class="modal-content rounded-0 border-0">
            ...
            <div class="modal-footer sticky-bottom justify-content-start px-5 bg-white">
                <div>
                    <button type="button" class="btn btn-light border" id=""><i class="fa-solid fa-print"></i>
                        Print</button>
                    <button type="button" class="btn btn-danger rounded-1" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        ...
        <div class="modal-content rounded-0 border-0">
            ...
            <div class="modal-body ps-0 pe-2">
                <div class="d-flex justify-content-end" style="height: 40px;">
                    <p><a href="#" id="edit-supplier-duty-btn">Edit Supplier Duty <i class="fa-solid fa-angle-right"></i></a></p>
                    <p><a href="#" id="close-supplier-duty-btn">Close Supplier Duty <i class="fa-solid fa-angle-left"></i></a></p>
                </div>
                <div class="d-flex justify-content-start">
                    <div class="ps-5 pe-4" style="width: 900px">
                        ...
                        <form action="">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty Start Date <span class="text-danger">*</span> </label>
                                        <input type="date" class="form-control  border-bottom" id="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty End Date <span class="text-danger">*</span> </label>
                                        <input type="date" class="form-control  border-bottom" id="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty Start Km <span class="text-danger">*</span> </label>
                                        <input type="number" class="form-control  border-bottom" id="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty Type <span class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty Start Time <span class="text-danger">*</span> </label>
                                        <select class="form-select border-bottom" name="" id="">
                                            <option value="">add time here</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty End Time <span class="text-danger">*</span> </label>
                                        <select class="form-select border-bottom" name="" id="">
                                            <option value="">add time here</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Duty End Km <span class="text-danger">*</span>
                                        </label>
                                        <input type="number" class="form-control  border-bottom" id="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label"> Vehicle Group <span class="text-danger">*</span> </label>
                                        <select class="form-select border-bottom" name="" id="">
                                            <option value="">add time here</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 col-4">
                                                <button type="button" class="btn btn-light border w-100" id="">Get
                                                    Price</button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="p-1">
                                        ...
                                        <div class="mb-3">
                                            <button type="button" class="btn btn-light border w-100" id="">Choose
                                                file</button>
                                        </div>
                                    </td>
                                    <td class="p-1">
                    ...
                    <div id="edit-supplier-duty-form" class="ps-4 pe-3 " style="display:none; width: 900px; border-left: 1px dashed black;">
...
{{-- add remove lable --}}
<div class="modal fade" id="add-remove-lable" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog float-end activity-logs-modal my-0 h-100 bg-white">
        <div class="modal-content rounded-0 border-0 h-100">
            <div class="modal-header px-5 sticky-top bg-white">
                <div>
...
{{-- Allot supporters --}}
<div class="modal fade" id="allot-supporters" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog float-end activity-logs-modal my-0 h-100 bg-white">
        <div class="modal-content rounded-0 border-0 h-100">
            <div class="modal-header px-5 sticky-top bg-white">
                <div>
...
<div class="modal fade" id="advance-purchase-payment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog float-end activity-logs-modal my-0 h-100 bg-white">
        <div class="modal-content rounded-0 border-0 h-100">
            <div class="modal-header px-5 sticky-top bg-white">
                <div>
...
<div class="modal fade" id="request-customer-feedback" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog float-end activity-logs-modal my-0 h-100 bg-white">
        <div class="modal-content rounded-0 border-0">
            <div class="modal-header px-5 sticky-top bg-white">
                <div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.open-detail-modal', function(e) {
            ...
            $('#details .modal-body').html('<p class="text-center">Loading...</p>');
            var dutyShowUrl = "{{ route('duty.booking.details', ':id') }}";
            let url = dutyShowUrl.replace(':id', dutyId);

            $.ajax({
                url: '/booking-details/' + dutyId, // <-- Laravel route e.g. Route::get('/duties/{id}')
                type: 'GET'
                , success: function(response) {
                    // Replace modal content with returned HTML
                    $template = `
                 <div class="modal-content rounded-0 border-0 h-100">
            <div class="modal-header px-5 sticky-top bg-white">
                <div>
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Duty Details - ${response.booking_details.id}</h1>
                </div>
                {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
            </div>
            <div class="modal-body px-5 bg-white">
                    ...
                    <div id="duty-detail-detail" class="tab-pane fade show active">
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                <tr>
                                    <th class="fw-medium">ID</th>
                                    <td>${response.booking_details.id}</td>
                                    <th class="fw-medium">Status</th>
                                    <td> ${response.booking_details.status}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Start Date</th>
                                    <td>${response.booking_details.start_date}</td>
                                    <th class="fw-medium">End Date</th>
                                    <td>${response.booking_details.end_date}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Garage Start Time</th>
                                    <td> ${response.booking_details.garage_time}</td>
                                    <th class="fw-medium">Reporting Time</th>
                                    <td>${response.booking_details.reporting_time}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">From City</th>
                                    <td> ${response.booking_details.from_service}</td>
                                    <th class="fw-medium">To City</th>
                                    <td> ${response.booking_details.to_service}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Duty Type</th>
                                    <td colspan="3">${response.booking_details.vehicle_group.name}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Vehicle Group</th>
                                ...
                                <tr>
                                    <th class="fw-medium">Customer</th>
                                    <td colspan="3"> ${response.booking_details.customers.name}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Supplier</th>
                                    <td colspan="3">Shanu Shaikh - ( <i class="fa-solid fa-phone text-success"></i>
                                ...
                                <tr>
                                    <th class="fw-medium">Reporting Address</th>
                                    <td colspan="3">${response.booking_details.reporting_address}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Flight/Train Number</th>
                                    <td colspan="3">6E-2215</td>
                                ...
                                <tr>
                                    <th class="fw-medium">Drop Address</th>
                                    <td colspan="3"><span class="text-secondary">${response.booking_details.reporting_address ?? 'NA'}</span></td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Price</th>
                                    <td>${response.booking_details.price ?? 'NA'}</td>
                                    <td><span class="fw-medium">Per Extra KM Rate: </span> ${response.booking_details.per_extra_km_rate ?? 'NA'}</td>
                                    <td><span class="fw-medium">Per Extra Hour Rate: </span> ${response.booking_details.per_extra_hr_rate ?? 'NA'}</td>
                                </tr>
                                <tr>
                                    <th class="fw-medium">Operator Notes</th>
                                    <td colspan="3"><span class="text-secondary">NA</span></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <ol class="ps-3" style="list-style-type: decimal;">
                                            <li>${response.booking_details.per_extra_hr_rate ?? 'NA'} - <i class="fa-solid fa-phone text-success"></i> <a href="tel:+9840872950" class="text-decoration-none ">
                                                    98408 72950 </a></li>
                                        </ol>
                                    </td>
                                </tr>
            ...
            `;
                    $('#details .modal-dialog').html($template);
                }
                , error: function() {
                    $('#details .modal-body').html('<p class="text-danger text-center">Failed to load data</p>');
                }
            });
        });
