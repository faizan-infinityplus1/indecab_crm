    ...
    <div class="card rounded-0 border-0 p-5">
        ...
        <ul class="nav nav-tabs border-0 d-flex flex-wrap mt-3">
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Upcoming</a>
            </li>
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Booked</a>
            </li>
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Allotted</a>
            </li>
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Dispatched</a>
            </li>
            <li class="nav-item position-relative">
            ...
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Incoming</a>
            </li>
            <li class="nav-item position-relative">
                <a class="nav-link text-dark fw-semibold px-3 py-2" href="#">Needs Attention</a>
            </li>
        </ul>
        ...
        <style>
            ...
            /* Remove Bootstrap's default shadow effect */
            .nav-tabs .nav-link {
        ...
        {{-- note Section --}}
        <div class="text-muted mb-3 px-3">
            Note: Only pending requests are shown, use search above to see Accepted/Rejected requests.
        </div>
        ...
        <div">
            <button class="btn btn-default btn-block border shadow-sm">
                Clear 20 Oldest Requests
            </button>
    </div>
    </div>
@endsection
