                                        ...
                                        @if ($data->status == 'allotted')
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                        ...
                                                        data-id="{{ $data->id }}">Update Supplier
                                                        Details</a>
                                                </li>
                                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                ...
                                                <li><a href="#"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#allot-vehicle-driver"
                                                        data-id="{{ $data->id }}">Re-allot</a></li>
                                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                ...
                                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                    id="send-info"
                                                        data-bs-target="#send-info"  data-id="{{ $data->id }}">Send info</a></li>
                                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
            ...
            $(document).on('click', '#allot_supporters', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const assignedIds = response.supporterAssign.map(s => s.supporter_id);

                        response.supporter.forEach(function(supporter) {
                            const isSelected = assignedIds.includes(supporter.id) ?
                                'selected' : '';
                            $select.append(
                        ...
                        // Handle Allot button click (unbind first to avoid duplicates)
                        $(document).off('click', '#allot_supporters_button').on('click',
                            '#allot_supporters_button',
                            function() {
                                const supporters = $select.val();
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        console.log('Supporters updated.');
                                        location.reload();
                                    }
                                });
                            });
