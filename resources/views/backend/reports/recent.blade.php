    ...
    <div class="card rounded-0 border-0 p-5">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('reports.index') }}"
                class="d-block text-decoration-none p-3 border-bottom text-secondary border-2 hover-link">Favourites</a>
            <a href="{{ route('reports.recent') }}"
                class="d-block text-decoration-none p-3 border-bottom border-primary border-2">Recent</a>
        </div>
