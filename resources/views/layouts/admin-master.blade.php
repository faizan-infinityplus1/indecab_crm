...
>>>>>>> 9f87fc24153deb2507372752795db4effc8a0b0d
                            ...
                            <li><a class="dropdown-item" href="{{ route('feedbackforms.index') }}">Feedback Forms</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('employees.index') }}">Employees</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{ route('billingitems.index') }}">Billing Items</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="{{ route('bankaccounts.index') }}">Bank Accounts</a>
                            </li>
        ...
        <div class="right_nav_menu d-flex align-items-center gap-3">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="#"><i class="fa-solid fa-building"></i> Your Account</a>
                    </li>
